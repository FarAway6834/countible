...
#define GET_CALLED_INDEX_SMARTLY(varname, frames, when_faild_to_get_current, when_faild_to_get_caller) GET_CALLER_SMARTLY(__caller__); int varname = GET_PC(frames)
